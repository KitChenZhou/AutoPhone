                ...
                if (tm.getSimState() != TelephonyManager.SIM_STATE_ABSENT) {
                    ...
                    if (!callState) {
                        ...
                        if (alreadyCallCount != 0 && !isExportReport) {
                            ...
                            dialog.setMessage("未导出EXCEL文件，是否继续？");
        ...
        getReports.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (alreadyCallCount != 0) {
                    ...
                    getCallInfo();//获取通话数据
                    isGetReport = true;
                    Utils.getReport(MainActivity.this, callRecordList, getReports);
                } else {
        ...
        exportFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isGetReport) {
                    ...
                    Utils.exportFile(MainActivity.this, callRecordList, exportFile); // 导出文件
                } else {
        ...
        switch (requestCode) {
            ...
            case REQUEST_CODE_ASK_STORAGE_SETTINGS:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Utils.exportFile(MainActivity.this, callRecordList, exportFile);
                } else {
